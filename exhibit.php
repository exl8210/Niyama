<?php include("header.php"); ?>
    ...
    <div class="row case-section">
        <div class="offset-by-one four columns">
            ...
            <p>When we pay attention to how we can influence others, we experience beautiful interruptions that can affect people in ways we may not have imagined.</p>

            <p><strong>In an era of negativity, a positive outlook is needed more than ever before.</strong></p>
    ...
    <div class="row case-section">
        ...
        <div class="six columns">
            ...
            <p>Visitors walk through an immersive space with ambient lighting and environmental sound, and interact with a large projection touchscreen.</p>
        </div>
    </div>
