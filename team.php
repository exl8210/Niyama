    ...
    <div class="row" id="team">
        <div class="offset-by-one ten columns" id="team-members">
            ...
            <div class="member">
                ...
                <h2>Natalie Magee</h2>
                <h3>Exhibit Designer</h3>

                <p>Lover of vegan donuts</p>
            ...
            <div class="member">
                ...
                <h2>Morgan Merrick</h2>
                <h3>Industrial Designer</h3>

                <p>Slightly coffee obsessed</p>
            ...
            <div class="member">
                ...
                <h2>Celina Tassone</h2>
                <h3>Product Designer</h3>

                <p>Might be lactose intolerant</p>
            </div>
        </div>
    </div>
